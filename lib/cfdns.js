(function($){
	...
	cfdns.setElements = function() {
		...
		cfdns.elems.entire_cache_btn = jQuery('#cfdns-entire-cache');
	...
	cfdns.purgeEntireCache = function() {
		cfdns.elems.entire_cache_btn.bind('click', function(e) {
			e.preventDefault();
